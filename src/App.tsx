    ...
    <BrowserRouter>
      <div className="flex flex-col min-h-screen bg-dark-bg text-gray-100 font-sans">
        ...
        <div className="fixed bottom-6 right-6 z-50 group">
          <div className="absolute bottom-full right-0 mb-3 px-3 py-2 bg-dark-card border border-dark-border rounded-lg text-white text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-xl">
